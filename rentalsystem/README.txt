...
3.- I focused on the requeriments demanded, so the CRUD operations of the entities were omitted. I provide the MySQL script that I used with some inserts included which is in the "db" folder.